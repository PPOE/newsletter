...
Piratenpartei Ã–sterreichs
        
Impressum: https://wiki.piratenpartei.at/wiki/Piratenwiki:Impressum
        
Kontakt zur TF Newsletter (Ã¶ffentlich!): tf-newsletter@forum.piratenpartei.at';
    if ($unsubscribe_link != null)
    {
        $message .= '
            
Einstellungen Ã¤ndern bzw. Abmeldung vom Newsletter: ' . $unsubscribe_link;
    }
    $to = base64_encode($to);

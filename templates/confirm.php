<div class="row">
    <div class="col-md-8">
        <div id="confirm_view" class="well">
            ...
            <p>
                Mit einem Klick auf den folgenden Link kannst du die Inhaltseinstellungen deines Newsletters verändern oder den Newsletter abbestellen:<br />
                <a href="<?php echo change_link($sid); ?>"><?php echo change_link($sid); ?></a>
            </p>

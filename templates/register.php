<div class="row">
    <div class="col-md-8">
        <div id="dse_view" class="well">
            ...
            <p><a href="register.php">Zur&uuml;ck</a></p>
        </div>
        ...
        <div id="form_view" class="well">
            ...
            ?>
            <p>
                Hier kannst du dich zum Newsletter der Piratenpartei Österreichs schnell und einfach anmelden.<br />
                Unsere aktuellen Datenschutzrichtlinien findest du hier: <a href="register.php?dse=1">Datenschutzrichtlinien</a>
            </p>
